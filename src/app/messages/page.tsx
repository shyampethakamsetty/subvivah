  ...
  return (
    <div className="flex flex-col h-screen bg-gray-50">
      ...
      <div className="flex flex-1 overflow-hidden">
        <div className="w-1/3 border-r bg-white overflow-y-auto shadow-sm">
          <div className="p-4">
              ...
              {conversations.map((conversation) => (
                <div
                  ...
                  onClick={() => setSelectedConversation(conversation)}
                    >
                  <div className="w-12 h-12 rounded-full bg-gray-200 flex items-center justify-center overflow-hidden mr-3 ring-2 ring-offset-2 ring-purple-100 flex-shrink-0">
                    {conversation.photo ? (
                      <img
              ...
              <form onSubmit={handleSendMessage} className="p-4 border-t bg-white shadow-sm">
                <div className="max-w-3xl mx-auto">
                  <div className="flex gap-2">
                      ...
                      className="flex-1 p-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent"
                      />
                      <button
                        type="submit"

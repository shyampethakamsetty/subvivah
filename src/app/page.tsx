...
export default function Home() {
  return (
    <div className="min-h-screen">
      ...
      <section className="relative min-h-screen flex items-center px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative z-10 max-w-7xl mx-auto py-24">
          <div className="text-center">
            ...
            <p className="text-2xl sm:text-3xl font-semibold text-white mb-8 drop-shadow-lg" style={{ fontFamily: 'var(--font-devanagari, sans-serif)' }}>
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4">
              <Link
                href="/register"
                className="bg-red-600 text-white px-8 py-3 rounded-lg text-lg font-semibold hover:bg-red-700 transition duration-300 shadow-lg"
              >
                Get Started
              </Link>
              <Link
                href="/search"
                className="bg-white/20 text-white border-2 border-white px-8 py-3 rounded-lg text-lg font-semibold hover:bg-white/30 transition duration-300 shadow-lg"
              >
                Browse Profiles
              </Link>
            </div>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-white to-red-50">

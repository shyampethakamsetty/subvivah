...
function PhotoGalleryPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-pink-50 to-blue-50 py-10 flex flex-col items-center">
      <div className="w-full max-w-2xl mx-auto px-2 sm:px-4 lg:px-6">
        ...
        <div className="mb-8 flex flex-col gap-2 items-start w-full">
          ...
          <div className="flex w-full items-center justify-between">
            <div className="text-left">
              ...
              <p className="text-gray-600 mt-1 text-base">Swipe or use arrows to browse your photos</p>
            </div>
            <button
        ...
        {photos.length > 0 ? (
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-6">
            {photos.map((photo, idx) => (
              <div
                key={idx}
                className="relative group rounded-xl overflow-hidden shadow-lg bg-white hover:shadow-xl transition-shadow cursor-pointer flex flex-col"
              ...
              >
                ...
                <div className="p-2 text-center bg-gradient-to-t from-white/90 to-white/60">
                  <p className="text-sm text-gray-700 truncate min-h-[1.5em]">{photo.caption || <span className='text-gray-400'>No caption</span>}</p>
                </div>
              </div>
            ))}
          </div>
        ...
        {selectedPhotoIndex !== null && photos.length > 0 && (
          ...
          >
            <div
              className="relative flex flex-col items-center bg-white rounded-2xl shadow-xl p-4 transition-all duration-300 max-w-2xl w-full"

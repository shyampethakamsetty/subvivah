...
const SAMPLE_FEATURES = [
  {
    ...
    title: "Vedic Wisdom",
    description: "Access ancient knowledge and spiritual guidance through AI-powered conversations"
  },
  {
  ...
  },
  {
    ...
    description: "Find peace and clarity through compassionate AI-guided conversations"
  },
  {
  ...
  },
  {
    ...
    description: "Get immediate responses to your spiritual and life questions"
  }
];
        ...
        <div className="bg-white/10 backdrop-blur-sm rounded-xl p-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="text-center select-none">
              ...
              <p className="text-purple-200">
                Our AI is trained on ancient Vedic texts and modern spiritual teachings to provide authentic guidance.
              </p>
            </div>
          </div>
        </div>

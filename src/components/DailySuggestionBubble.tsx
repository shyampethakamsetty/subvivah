          ...
          <div className="bg-gradient-to-b from-white to-pink-50 rounded-xl shadow-xl p-5 w-[340px] relative overflow-hidden">
            ...
            <div className="space-y-4 relative z-10">
              ...
              <div className="flex justify-center">
                {matchedProfile.user.photos?.[0] ? (
                  <div className="w-20 h-20 rounded-full overflow-hidden shadow-lg hover:scale-105 transition-transform duration-300">
                    <img
                      src={matchedProfile.user.photos[0].url}
                      alt={`${matchedProfile.user.firstName}'s profile`}

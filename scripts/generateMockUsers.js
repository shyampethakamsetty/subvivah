...
const generateAIPersonalization = () => ({
  ...
  religionSpirituality: getRandomElement(['Very Religious', 'Moderately Religious', 'Spiritual but not Religious']),
  ...
  marriageTimeline: getRandomElement(['Within 6 months', '6-12 months', '1-2 years']),
